...
# Author: Vern Wolfley
# Class: CSE 111
# Purpose: 10 Team Activity: Handling Exceptions
# Add exception handling code to validate the user's
#  input and print helpful error messages when the 
...
def main():
    ...
    #     print("Run the program again and enter the name of a file that you are allowed to read.")
        ...
        print("You entered an invalid integer for the percent reduction number.")
        print("Run the program again and enter an integer for the percent reduction.")
        ...
        if perc_reduc < 0:
            print(f"{perc_reduc} is a less than 0.")
        else:
            print(f"{perc_reduc} is a greater than 100.")

        print(f"Run the program again and enter a number between 1 and 100.")
